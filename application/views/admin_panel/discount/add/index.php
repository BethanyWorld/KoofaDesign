...
<section class="content">
                    ...
                    <div class="body">
                        ...
                        <ul class="nav nav-tabs tab-nav-right p-0" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#brandBasicInfo" data-toggle="tab">اطلاعات کد تخفیف</a>
                            </li>
                            <li class="hidden" role="presentation">
                                <a href="#brandCategories" data-toggle="tab">دسته بندی های مرتبط</a>
                            </li>
                            <li role="presentation">
                                <a href="#productFinalizeOperation" data-toggle="tab">ثبت و ذخیره</a>
                            </li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="brandBasicInfo">
                                <div class="col-xs-12 col-sm-3">
                                    <label for="inputDiscountCode">کد تخفیف</label>
 ...
 <!--  در این بخش فقط کد های تخفیف از نوع عادی و دسته بندی قابل انتخاب می باشد.سایر نوع کد ها در محصولات و کاربر ها قابل انتخاب است  -->
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="productFinalizeOperation">
                                ...
                                <div class="col-xs-12">
                                    <button type="button" id="addDiscountCode" class="btn btn-primary waves-effect">ذخیره
                                    </button>
                                </div>
                            </div>
                        </div>
