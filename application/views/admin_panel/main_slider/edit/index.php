...
<input type="hidden"
       value="<?php echo $data['SlideId']; ?>"
       id="inputSlideId" name="inputSlideId" />
                    ...
                    <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control"
                                           value="<?php echo $data['SlideImage']; ?>"
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control ltr"
                                           value="<?php echo $data['SlideButtonTitle']; ?>"
                        ...
                        <div class="col-xs-12">
                            <button type="button" id="editSlide" class="btn btn-primary waves-effect">ذخیره</button>
                        </div>
                    </div>
                </div>
            </div>
