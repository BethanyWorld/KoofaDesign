...
<input type="hidden" id="inputOrderId" <?php setInputValue($orderInfo[0]['OrderId']); ?> />
            ...
            <div class="col-xs-12 rtl">
                <div class="row col-xs-12 card">
                    <div class="body">
                        ...
                        <div class="col-xs-12 col-md-6"> <div class="col-xs-12 RightFloat padding-0">
                                <?php
                                if(empty($orderItems)){
                                                         ...
                                                         <?php if ($item['ProductUploadImage'] != '') { ?>
                                                             <a class="btn btn-default" target="_blank"
                                                                href="<?php echo $item['ProductUploadImage']; ?>">
                                                                 مشاهده طرح بریده شده توسط کاربر
                                                             </a>
                                                         <?php } ?>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-md-12 col-xs-12 cart-product-detail">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <?php if($item['ProductType'] == 'DesignFixSize'){ ?>
                ...
                <div class="row col-xs-12 card">
                    <div class="body">
                        <div class="col-xs-12">
                            ...
                            <select id="inputOrderStatus">
                                <?php foreach ($enum as $key=>$value) { ?>
                                    <option
                                           <?php setOptionSelected($key , $order['OrderStatus']); ?>
                                            value="<?php echo $key ?>">
                                        <?php echo $value; ?>
                                    </option>
                                <?php } ?>
                            </select>
                            <button class="btn btn-primary" id="setOrderStatus">تعیین وضعیت</button>
                        </div>
                    </div>
                </div>
            </div>
