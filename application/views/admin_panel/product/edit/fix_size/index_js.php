<script type="text/javascript">
    $(document).ready(function () {
        /* Update User Info */
        $("#editDesignFixSize").click(function () {
            ...
            $(".inputProductTempSize").each(function () {
                $inputProductSize.push( $(this).val());
            });
            ...
            if (isEmpty($inputProductTitle) ||
                ...
                $.ajax({
                    type: 'post',
                    url: base_url + 'Product/doEditDesignFixSizeProduct',
                    data: $sendData,
        ...
        $("#CopyDesignFixSize").click(function () {
            ...
            if (isEmpty($inputProductTitle) ||
                ...
                $.ajax({
                    type: 'post',
                    url: base_url + 'Product/doAddDesignFixSizeProduct',
                    data: $sendData,
                    success: function (data) {
                        toggleLoader();
                        $result = jQuery.parseJSON(data);
