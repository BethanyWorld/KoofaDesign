                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="productBasicInfo">
                                <div class="col-xs-12 col-sm-6">
                                    <label for="inputProductTitle">نام محصول</label>
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <label for="inputProductTitle">نوع محصول</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-xs-12">
                                    <label for="inputProductDescription">شرح محصول</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea
                                                    type="text"
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea
                                                    ...
                                                    name="inputProductDescriptionTable"><?php echo $data['ProductDescriptionTable']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="productImages">
                                <div class="col-md-6 col-xs-12">
                                    <label for="inputProductPrimaryImage">تصویر اصلی محصول</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control"
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="productPrice">
                                <div class="col-xs-12 col-sm-3">
                                    <label for="inputProductSalePrice">جنس</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-xs-12 col-sm-3">
                                    <label for="inputProductSalePrice">قیمت (cm)</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control"
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="productFinalizeOperation">
                                ...
                                <div class="col-xs-12">
                                    <button type="button" id="editDesignFreeSize" class="btn btn-primary waves-effect">
                                        ذخیره
                                    </button>
                                    <button type="button" id="CopyDesignFreeSize" class="btn btn-success waves-effect pull-left">
                                        کپی محصول
                                    </button>
                                </div>
                            </div>
