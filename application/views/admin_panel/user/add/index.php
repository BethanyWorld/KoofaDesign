                    ...
                    <div class="body">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 pull-right">
                            ...
                            <select class="form-control"  name="inputUserCityId" id="inputUserCityId">
                                <option value="0">-- انتخاب کنید --</option>
                                <?php
                                if(isset($userInfo['UserStateId']) && $userInfo['UserStateId']!=""){ ?>
                                    <?php foreach ($cities as $city) { ?>
                                        <option <?php if($userInfo['UserCityId'] == $city['CityId']) echo "selected"; ?> value="<?php echo $city['CityId'];  ?>">
                        ...
                        <div class="col-xs-12">
                            <button type="button" id="addUser" class="btn btn-primary waves-effect">ذخیره
                            </button>
                        </div>
                    </div>
                </div>
