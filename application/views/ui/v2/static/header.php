...
<head>
    ...
    <link rel="manifest" href="<?php echo $_DIR; ?>assets/img/fav/site.webmanifest">
    <link rel="mask-icon" href="<?php echo $_DIR; ?>assets/img/fav/safari-pinned-tab.svg" color="#5bbad5">
