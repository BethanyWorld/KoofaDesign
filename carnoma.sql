...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2019 at 02:05 PM
...
CREATE TABLE `brand_category_relation` (
...
CREATE TABLE `orders_sending_method` (
  `OrderSendMethodId` int(11) NOT NULL,
...
(54, 'تابلو فرش ماشینی شبیر مدل PC17-6635', 'تابلو فرش ماشینی شبیر مدل PC17-6635', 1, '', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_48.jpg', 'تراکم بافت در هفت سانتی‌متر 50 رج', '<ul>\n <li>\n <p>محل بافت:کاشان</p>\n </li>\n <li>\n <p>نوع بافت:ماشینی</p>\n </li>\n <li>\n <p>ابعاد تابلو:55×70 سانتی متر</p>\n </li>\n <li>\n <p>ابعاد فرش:35×50 سانتی متر</p>\n </li>\n <li>\n <p>وزن تقریبی:3 کیلوگرم</p>\n </li>\n <li>\n <p>تراکم بافت در هفت سانتی‌متر:50 رج</p>\n </li>\n <li>\n <p>جنس پرز:پلی‌استر</p>\n </li>\n <li>\n <p>جنس نخ تار (چله):پلی‌استر</p>\n </li>\n <li>\n <p>جنس نخ پود:پلی‌استر</p>\n </li>\n <li>\n <p>جنس نخ خاب:پلی‌استر</p>\n </li>\n <li>\n <p>تراکم طولی فرش (تراکم):2550</p>\n </li>\n <li>\n <p>تراکم عرضی فرش (شانه):1000</p>\n </li>\n <li>\n <p>جنس قاب:PVC</p>\n </li>\n</ul>\n', 'DesignFixSize', 0, 0, 0, 0, 0, 0, '1398/09/07 22:15:47', '1398/09/07 22:15:47'),
...
CREATE TABLE `productspecialsale` (
  `RowId` bigint(20) NOT NULL,
...
(13, 'کوسن', 1, 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_31.jpg', 0, 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', '1398/09/08 12:09:47'),
...
(25, 'محصولات غذایی', 1, 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_24.jpg', 0, 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', '1398/09/08 12:09:59'),
(26, 'تنقلات', 25, 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_18.jpg', 1, 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', '1398/08/30 11:57:04'),
...
CREATE TABLE `product_category_property_options` (
  `CategoryPropertyOptionId` bigint(20) NOT NULL,
...
CREATE TABLE `product_main_slider` (
...
INSERT INTO `user` (`UserId`, `UserFirstName`, `UserLastName`, `UserPhone`, `UserEmail`, `UserPassword`, `UserActivationCode`, `UserIsActive`, `ModifiedDateTime`, `CreateDateTime`) VALUES
(4, 'محمدرضا', 'اسماعیلی', '09120572107', '', '827ccb0eea8a706c4c34a16891f84e7b', '1803', 1, '1398-08-19 21:19', '1398-08-19 21:19');
...
CREATE TABLE `user_address` (
  ...
  `UserAddressStateId` int(11) NOT NULL,
  `UserAddressCityId` int(11) NOT NULL,
  `UserAddress` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL,
  `UserPostalCode` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `UserSecondPhone` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `UserId` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `brand_category_relation`
--
ALTER TABLE `brand_category_relation`
...
--
-- Indexes for table `orders_sending_method`
--
ALTER TABLE `orders_sending_method`
  ADD PRIMARY KEY (`OrderSendMethodId`);
...
--
-- Indexes for table `productspecialsale`
--
...
--
-- Indexes for table `product_category_property`
--
ALTER TABLE `product_category_property`
  ADD PRIMARY KEY (`PropertyId`);

--
-- Indexes for table `product_category_property_options`
--
ALTER TABLE `product_category_property_options`
  ADD PRIMARY KEY (`CategoryPropertyOptionId`);
...
--
-- Indexes for table `product_main_slider`
--
ALTER TABLE `product_main_slider`
...
ALTER TABLE `product_material`
  ...
  ADD UNIQUE KEY `MaterialTitle` (`MaterialTitle`);
...
ALTER TABLE `product_size`
  ...
  ADD UNIQUE KEY `SizeTitle` (`SizeTitle`);
...
--
-- AUTO_INCREMENT for table `brand_category_relation`
--
ALTER TABLE `brand_category_relation`
...
--
ALTER TABLE `city`
  MODIFY `CityId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=441;
--
...
--
ALTER TABLE `manager`
  MODIFY `ManagerId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `media`
--
ALTER TABLE `media`
  MODIFY `MediaId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
--
...
--
-- AUTO_INCREMENT for table `orders_sending_method`
--
ALTER TABLE `orders_sending_method`
  MODIFY `OrderSendMethodId` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `order_items`
--
ALTER TABLE `order_items`
  MODIFY `RowId` bigint(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `product`
  MODIFY `ProductId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
-- AUTO_INCREMENT for table `productspecialsale`
--
ALTER TABLE `productspecialsale`
  MODIFY `RowId` bigint(20) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `product_category`
  MODIFY `CategoryId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `product_category_property`
--
ALTER TABLE `product_category_property`
  MODIFY `PropertyId` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `product_category_property_options`
--
ALTER TABLE `product_category_property_options`
  MODIFY `CategoryPropertyOptionId` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `product_category_relation`
--
ALTER TABLE `product_category_relation`
  MODIFY `RowId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=442;
--
...
--
-- AUTO_INCREMENT for table `product_main_slider`
--
ALTER TABLE `product_main_slider`
...
--
ALTER TABLE `product_material`
  MODIFY `MaterialId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `product_price`
--
ALTER TABLE `product_price`
  MODIFY `PriceId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=263;
--
...
--
ALTER TABLE `product_tags`
  MODIFY `TagId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=244;
--
...
--
ALTER TABLE `user_address`
  MODIFY `UserAddressId` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `user_meta`
--
ALTER TABLE `user_meta`
  MODIFY `UserMetaId` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `user_wish_list`
--
ALTER TABLE `user_wish_list`
  MODIFY `RowId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
