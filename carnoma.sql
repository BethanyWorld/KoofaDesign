...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 09, 2020 at 10:56 AM
...
INSERT INTO `discount` (`DiscountId`, `DiscountCode`, `DiscountType`, `DiscountUserId`, `DiscountStartTime`, `DiscountEndTime`, `DiscountPercent`, `DiscountPrice`, `DiscountCategoryId`, `DiscountProductId`, `CreateDateTime`) VALUES
(2, 'T-10', 'GeneralBase', NULL, NULL, NULL, 10, 0, NULL, NULL, '1398/10/01 21:19:24'),
(3, 'T-1000', 'GeneralBase', NULL, NULL, NULL, 0, 1000, NULL, NULL, '1398/10/01 21:21:25');
...
(1, 'محمدرضا اسماعیلی', '09120572107', 'info@kofadesign.com', '827ccb0eea8a706c4c34a16891f84e7b');
...
(144, 'Product', 41, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_8.jpg'),
(145, 'Product', 41, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_9.jpg'),
(146, 'Product', 41, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_10.jpg'),
(147, 'Product', 41, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_11.jpg'),
(149, 'Product', 47, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_30.jpg'),
(154, 'Product', 58, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_59.jpg'),
(155, 'Product', 58, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_60.jpg'),
(158, 'Product', 57, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_56.jpg'),
(159, 'Product', 57, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_57.jpg'),
(160, 'Product', 49, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_36.jpg'),
(161, 'Product', 49, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_37.jpg'),
(162, 'Product', 39, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80.jpg'),
(163, 'Product', 39, 'jpg', 'http://localhost:8080/KoofaDesign/media/responsivefilemanager/source/normal_upload/qualityq_80_2.jpg');
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `OrderAddressId` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `OrderSendMethodId` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `OrderSendMethodPrice` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `OrderTotalPrice` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `OrderDiscountCode` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `orders_sending_method`
--

INSERT INTO `orders_sending_method` (`OrderSendMethodId`, `OrderSendMethodTitle`, `OrderSendMethodPrice`, `OrderSendMethodActive`, `CreateDateTime`, `ModifiedDateTime`) VALUES
(1, 'ارسال رایگان', 0, 'Active', '1398/09/22 15:03:40', '1398/09/22 15:03:40'),
(2, 'ارسال پیشتاز', 15500, 'Active', '1398/09/22 15:03:53', '1398/09/22 15:03:53'),
(3, 'ارسال تیباکس', 50000, 'Active', '1398/09/22 15:04:08', '1398/09/22 15:04:08');
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  `ProductUploadImage` varchar(254) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ProductMaterialId` int(11) DEFAULT NULL,
  `ProductSizeId` int(11) DEFAULT NULL,
  `ProductHeight` int(11) DEFAULT NULL,
  `ProductWidth` int(11) DEFAULT NULL,
  `ProductDiscountPrice` int(11) DEFAULT NULL,
  `ProductDiscountCode` varchar(254) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`RowId`)
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `ProductIsSpecial` bit(1) NOT NULL DEFAULT b'0',
  `ProductSpecialEndDate` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(265, 'ماگ', 47),
(270, 'تابلو فرش', 58),
(271, 'تابلو فرش حریر', 58),
(278, 'کاغذ دیواری', 66),
(279, 'کاغذ دیواری', 66),
(280, 'تابلو فرش', 57),
(281, 'تابلو فرش حریر', 57),
(282, 'تابلو فرش چوبی', 57),
(283, 'ماگ', 49),
(284, 'ماگ مندلیف', 49),
(285, 'بیسکوییت', 39),
(286, 'گرجی', 39);
...
(3, 'محمدرضا اسماعیلی', 'info@mail.com', '09120572107', '02165228155', '3355156695', 'تهران', 'تهران', 'شهریار خیابان ولعصر خیابان 17 شهریور کوچه شایسته', 4);
